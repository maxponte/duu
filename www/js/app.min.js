...
angular.module('DukeUniversityUnion.services.Cordova', [])
...
angular.module('DukeUniversityUnion.controllers.Sidebar', []).controller('SidebarCtrl', ["$scope", "getCurrentPosition", "getWeather", function($scope, getCurrentPosition, getWeather){
  var sidebar = this;
  sidebar.navigation = {
    links : [
      {label : 'Home', href : '#/'},
...
angular.module('DukeUniversityUnion.controllers.Events', []).controller('EventsCtrl', ["$scope", "getCurrentPosition", "getWeather", function($scope, getCurrentPosition, getWeather){
  var eventInfo = this;
  eventInfo.events = [
  	{
...
angular.module("DukeUniversityUnion").run(["$templateCache", function($templateCache) {$templateCache.put("events.html","<section class=\"section container-fluid\" ng-controller=\"EventsCtrl as eventInfo\">\n  <div ng-repeat=\"event in eventInfo.events\">\n  	<h1>{{event.title}}</h1>\n  	<p>{{event.description}}</p>\n  	<p>{{event.time}}</p>\n  	<p>{{event.location}}</p>\n  </div>\n</section>");
$templateCache.put("home.html","<section class=\"section container-fluid\">\n  <div bs-panel title=\"{{location}}\">\n    {{weather}}\n  </div>\n</section>");
$templateCache.put("sidebar.html","<h1 class=\"app-name\">Duke University Union</h1>\n\n<div class=\"scrollable sidebar-scrollable\" ng-controller=\"SidebarCtrl as sidebar\">\n  <div class=\"scrollable-content\">\n    <div class=\"list-group\" toggle=\"off\" bubble target=\"mainSidebar\">\n      <a ng-repeat=\"linkObject in sidebar.navigation.links\" class=\"list-group-item\" ng-href=\"{{linkObject.href}}\">{{linkObject.label}} <i class=\"fa fa-chevron-right pull-right\"></i></a>\n    </div>\n  </div>\n</div>");}]);
